...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "agentExecutionMode", GoGetter: "AgentExecutionMode"},
			_jsii_.MemberProperty{JsiiProperty: "agentExecutionModeInput", GoGetter: "AgentExecutionModeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetAgentExecutionMode", GoMethod: "ResetAgentExecutionMode"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTagPrefix", GoMethod: "ResetTagPrefix"},
			...
			_jsii_.MemberProperty{JsiiProperty: "tagPrefixInput", GoGetter: "TagPrefixInput"},
