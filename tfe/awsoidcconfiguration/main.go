...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AwsOidcConfiguration)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-tfe.awsOidcConfiguration.AwsOidcConfigurationConfig",
		reflect.TypeOf((*AwsOidcConfigurationConfig)(nil)).Elem(),
	)
}
