...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "effectiveTagsInput", GoGetter: "EffectiveTagsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEffectiveTags", GoMethod: "ResetEffectiveTags"},
