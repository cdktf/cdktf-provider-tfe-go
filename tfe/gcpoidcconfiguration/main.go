...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-tfe.gcpOidcConfiguration.GcpOidcConfiguration",
		reflect.TypeOf((*GcpOidcConfiguration)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "workloadProviderName", GoGetter: "WorkloadProviderName"},
			_jsii_.MemberProperty{JsiiProperty: "workloadProviderNameInput", GoGetter: "WorkloadProviderNameInput"},
		},
		func() interface{} {
			j := jsiiProxy_GcpOidcConfiguration{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-tfe.gcpOidcConfiguration.GcpOidcConfigurationConfig",
		reflect.TypeOf((*GcpOidcConfigurationConfig)(nil)).Elem(),
	)
}
