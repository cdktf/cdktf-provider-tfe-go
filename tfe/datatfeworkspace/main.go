...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "applyDurationAverage", GoGetter: "ApplyDurationAverage"},
			...
			_jsii_.MemberProperty{JsiiProperty: "hyokEnabled", GoGetter: "HyokEnabled"},
			...
			_jsii_.MemberProperty{JsiiProperty: "planDurationAverage", GoGetter: "PlanDurationAverage"},
			...
			_jsii_.MemberProperty{JsiiProperty: "settingOverwrites", GoGetter: "SettingOverwrites"},
