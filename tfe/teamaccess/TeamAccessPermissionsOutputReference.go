...
import (
	...
	"github.com/cdktf/cdktf-provider-tfe-go/tfe/v12/teamaccess/internal"
...
func (t *jsiiProxy_TeamAccessPermissionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TeamAccessPermissionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
