...
import (
	...
	"github.com/cdktf/cdktf-provider-tfe-go/tfe/v12/workspace/internal"
...
func (w *jsiiProxy_WorkspaceVcsRepoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WorkspaceVcsRepoOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
