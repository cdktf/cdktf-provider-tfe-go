...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "hyokEnabledInput", GoGetter: "HyokEnabledInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetHyokEnabled", GoMethod: "ResetHyokEnabled"},
