...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "enforceHyok", GoGetter: "EnforceHyok"},
			_jsii_.MemberProperty{JsiiProperty: "enforceHyokInput", GoGetter: "EnforceHyokInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEnforceHyok", GoMethod: "ResetEnforceHyok"},
