...
import (
	...
	"github.com/cdktf/cdktf-provider-tfe-go/tfe/v12/workspacerun/internal"
...
func (w *jsiiProxy_WorkspaceRunDestroyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WorkspaceRunDestroyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
