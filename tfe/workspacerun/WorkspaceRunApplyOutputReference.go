...
func (w *jsiiProxy_WorkspaceRunApplyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WorkspaceRunApplyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
