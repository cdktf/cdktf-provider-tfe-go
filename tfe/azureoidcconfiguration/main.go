...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AzureOidcConfiguration)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-tfe.azureOidcConfiguration.AzureOidcConfigurationConfig",
		reflect.TypeOf((*AzureOidcConfigurationConfig)(nil)).Elem(),
	)
}
